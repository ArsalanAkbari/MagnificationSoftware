...
namespace MagnifierSoftwareV_1.MouseMove.MouseMoveTest
{
    internal static class NativeMethods
    {
        ...
        [DllImport("user32.dll")]
        internal static extern bool SetWindowPos(IntPtr hWnd, int hWndPutAfter, int x, int y, int cx, int cy, uint flags);
        ...
        {
            IntPtr hCurs = LoadCursorFromFile(Application.StartupPath + "\\cursor.cur");
        ...
        [DllImport("Magnification.dll", CallingConvention = CallingConvention.StdCall)]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool MagGetInputTransform(bool fEnabled, RECT prcSource, RECT prcDest);
        ...
        // For changing all of the screen color Not just the MAgnifier Window
