       ...
       // private int ElipsFalsePoints = 0;
        ...
        private void doTesting(object sender, System.EventArgs e)
        {
            ...
            if (doingRectangle)
            {
                ...
                if (counter <0)
                {
                    ...
                    OnTimerDrwRectangle();
                    timer.Enabled = true;
                    label1.Text = "Third Test will be start in 3 seconds!";
                    label1.Visible = true;
                    System.Threading.Thread.Sleep(1300);
        ...
        private void saveTheTestingImage(string Mode , List<Point> gazePoints , List<Point> shapePoints )
        {
            ...
            if (finishTesting)
            {
                ...
                ChartsForm ch = new ChartsForm(lineTruePoints, lineFalsePoints, RectangleTruePoints, RectangleFalsePoints, TextTruePoints, TextFalsePoints, addressToSaveChart , mConfiguration);
                ch.Show();
            }
        }
