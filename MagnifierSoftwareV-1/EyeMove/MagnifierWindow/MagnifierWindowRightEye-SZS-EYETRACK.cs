...
{
    public class MagnifierWindowRightEye : IDisposable
    {
        private Form form;
        ...
        public MagnifierWindowRightEye(Form form, Configuration configuration, OverlayEyeNew overlayEyeNewForm, MouseController mController)
        {
        ...
        public virtual void UpdateMaginifier()
        {
            ...
            Point target = calculateTargetPoint(warpPointEye);
