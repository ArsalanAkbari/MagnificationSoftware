...
{
    public class MagnifierWindowRightEyeAndHead : IDisposable
    {
        private Form form;
        ...
        public MagnifierWindowRightEyeAndHead(Form form, Configuration configuration, OverlayEyeNew overlayEyeNewForm, MouseController mController)
        {
        ...
        ~MagnifierWindowRightEyeAndHead()
        {
            Dispose(false);
        }
        ...
        public virtual void UpdateMaginifier()
        {
            ...
            //*************************Take Eye Gaze From Right Eye and head**********************************************//
            ...
            {
                Point gazePoint = rightEyeGaze.GetWarpPoint();
                Point warpPointEye = rightEyeGaze.GetNextPoint(gazePoint);
                Point targetEye = calculateTargetPoint(warpPointEye);
                //Console.WriteLine();

                //Calcute Head + Eye Left Position
                Vector3 headPoint = headPoints.GetHeadPoint();
                Point warpPoint = headPoints.GetNextPoint(targetEye);
        ...
        private Point findEyeGaze(Point gazePoint)
        {
            //Point gazePoint = rightEyeGaze.GetWarpPoint();
            Point warpPoint = rightEyeGaze.GetNextPoint(gazePoint);
