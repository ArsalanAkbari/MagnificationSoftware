...
namespace MagnifierSoftwareV_1.MouseMove.MouseMoveTest
{
    public class MagnifierWindowsBothEye : IDisposable
    {
        ...
        public PointF calculateTargetPoint(Point gazePoint)
        {
            ...
            if (gazePoint.X > noMoveArea.right - width * fastMargin)
                retTarget.X += (Math.Abs((gazePoint.X - (noMoveArea.right - width * slowMargin))) / m_MAGFACTOR + 1);

            else if (gazePoint.X > noMoveArea.right - width * slowMargin)
                retTarget.X += (Math.Abs((gazePoint.X - (noMoveArea.right - width * slowMargin))) / m_MAGFACTOR / m_MAGFACTOR + 1);

            if (gazePoint.X < noMoveArea.left + width * fastMargin)
                retTarget.X += -(Math.Abs((gazePoint.X - (noMoveArea.left + width * slowMargin))) / m_MAGFACTOR + 1);

            else if (gazePoint.X < noMoveArea.left + width * slowMargin)
                retTarget.X += -(Math.Abs((gazePoint.X - (noMoveArea.left + width * slowMargin))) / m_MAGFACTOR / m_MAGFACTOR + 1);

            if (gazePoint.Y > noMoveArea.bottom - height * fastMargin)
                retTarget.Y += (Math.Abs((gazePoint.Y - (noMoveArea.bottom - height * slowMargin))) / m_MAGFACTOR + 1);

            else if (gazePoint.Y > noMoveArea.bottom - height * slowMargin)
                retTarget.Y += (Math.Abs((gazePoint.Y - (noMoveArea.bottom - height * slowMargin))) / m_MAGFACTOR / m_MAGFACTOR + 1);

            if (gazePoint.Y < noMoveArea.top + height * fastMargin)
                retTarget.Y += -(Math.Abs((gazePoint.Y - (noMoveArea.top + height * slowMargin))) / m_MAGFACTOR + 1);

            else if (gazePoint.Y < noMoveArea.top + height * slowMargin)
                retTarget.Y += -(Math.Abs((gazePoint.Y - (noMoveArea.top + height * slowMargin))) / m_MAGFACTOR / m_MAGFACTOR + 1);
