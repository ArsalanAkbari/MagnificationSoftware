...
namespace MagnifierSoftwareV_1.EyeMove.MagnifierWindow
{
    public class MagnifierWindowLeftEye : IDisposable
    {
        ...
        public MagnifierWindowLeftEye(Form form, Configuration configuration, OverlayEyeNew overlayEyeNewForm)
        {
            ...
            mOverlayEyeNewForm = overlayEyeNewForm;
        ...
        void timer_Tick(object sender, EventArgs e)
        {
            ...
            UpdateMaginifier();
            //mOverlayEyeNewForm.Invalidated();
        }
        ...
        public Point calculateTargetPoint(Point gazePoint)
        {
            ...
            int width = (int)((noMoveArea.right - noMoveArea.left) * mConfiguration.ZoomFactor);
            int height = (int)((noMoveArea.bottom - noMoveArea.top) * mConfiguration.ZoomFactor);
