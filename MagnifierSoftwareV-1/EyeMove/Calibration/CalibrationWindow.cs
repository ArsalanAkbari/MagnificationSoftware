...
namespace MagnifierSoftwareV_1
{
    public partial class CalibrationWindow : Form
    {
        ...
        int h = Screen.PrimaryScreen.Bounds.Height;
            ...
            /*RectangleF recBegin2 = new RectangleF(0.49f * w, 0.5f * h, 30, 30);
            e.Graphics.FillEllipse(Brushes.White, recBegin2);

            RectangleF recBegin3 = new RectangleF(0.51f * w, 0.5f * h, 30, 30);
            e.Graphics.FillEllipse(Brushes.White, recBegin3);

            RectangleF recBegin4 = new RectangleF(0.5f * w, 0.49f * h, 30, 30);
            e.Graphics.FillEllipse(Brushes.White, recBegin4);

            RectangleF recBegin5 = new RectangleF(0.5f * w, 0.51f * h, 30, 30);
            e.Graphics.FillEllipse(Brushes.White, recBegin5);*/
